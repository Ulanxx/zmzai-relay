...
const adminLinks = [["概览", "/admin"], ["模型目录", "/admin/models"], ["渠道", "/admin/channels"], ["用户与余额", "/admin/users"], ["调用与账本", "/admin/activity"], ["Token", "/admin/keys"]] as const;
const userLinks = [["概览", "/dashboard"], ["模型", "/dashboard/models"], ["我的 Token", "/dashboard/keys"], ["用量与账单", "/dashboard/activity"], ["调用文档", "/dashboard/docs"]] as const;
