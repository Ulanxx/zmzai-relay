...
- Fix: generate the current Asia/Shanghai billing month through a shared `currentPeriod` helper and invoke it with a zero-argument schema default. Mongoose otherwise passes the document as the first function argument.
